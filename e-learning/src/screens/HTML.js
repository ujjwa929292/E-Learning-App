    ...
    return (
        <ScrollView style={{ flex: 1,marginTop: 10 }}>
            <View style={{ flex: 1, alignItems: 'center'}}>
                <Image source={require('../images/htmlcover.png')} style={{ width: 350, height: 200, resizeMode: 'contain', borderRadius: 20 }} />
            </View>
            <View style={styles.content}>
                <Text style={styles.title}>HTML & CSS in 4 Hours</Text>
