    ...
    return (
        <ScrollView style={{ flex: 1,marginTop: 10 }}>
            <View style={{ flex: 1, alignItems: 'center'}}>
                <Image source={require('../images/dockercover.png')} style={{ width: 350, height: 200, resizeMode: 'contain', borderRadius: 20 }} />
            </View>
            <View style={styles.content}>
                <Text style={styles.title}>Learn Docker in 24 Hours</Text>
